...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-jingum/src/utils/date-util';
  import ElScrollbar from 'element-ui-jingum/packages/scrollbar';
  import RepeatClick from 'element-ui-jingum/src/directives/repeat-click';
