...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'element-ui-jingum/src/utils/date-util';
  import { hasClass } from 'element-ui-jingum/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'element-ui-jingum/src/utils/util';
