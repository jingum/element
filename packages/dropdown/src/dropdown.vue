<script>
  ...
  import ElButton from 'element-ui-jingum/packages/button';
  import ElButtonGroup from 'element-ui-jingum/packages/button-group';
  import { generateId } from 'element-ui-jingum/src/utils/util';
