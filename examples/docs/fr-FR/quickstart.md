...
```javascript
import Vue from 'vue';
import ElementUI from 'element-ui-jingum';
import 'element-ui-jingum/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-ui-jingum';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-ui-jingum';
